    ...
    private double y= 0;
      public void loginAdmin(){
        ...
        try{ // IT WORKS GOOD : ) NOW LETS DESIGN THE DASHBOARD FORM : ) 
            ...
            prepare.setString(2, passFeild.getText());
            System.out.print(passFeild.getText());
            result = prepare.executeQuery();
//            CHECK IF FIELDS ARE EMPTTY
            if(username.getText().isEmpty() || passFeild.getText().isEmpty()){
